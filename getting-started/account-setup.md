...
#### Logging On
Add detail to your account manually here or by linking existing credentials 
- LinkedIn
- Github

#### Build connections to the DIMO Graph: 
...
#### Wallet Setup
Sign up for a wallet using [Metamask](https://metamask.io/download.html) and add your wallet address to your [person] or [org] account so you can receive incoming payments. 

- With your subscription you'll get credits each month to spend on [tasks](https://airtable.com/shrWuPpuUlE3MaTMy). 
- You can also earn credits for completing open [tasks](https://airtable.com/shrPF3YpMMleSLAPc) or contributing useful [functions](https://airtable.com/shraU5h8oNmfBAk2L)
...
#### Invite a Team and Start Building a [Project] together
