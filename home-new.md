...
- Hiring
- Contract for a task or job
- Insurance
- Performance Bonding
- Services Contract

A well-crafted [Deal] will detail performance targets and specific requirements linked to existing [functions], [devices], [orgs], and [people] working on the [project].

[Deal] information will allow for the [project] to be tracked and reviewed based upon the initial target/metrics that were put in place. [Orgs] can use the [deal] as an example of how to execute a certain [project] in another location. By understanding the [deal] terms, pricing, [functions], and other aspects, they can more easily start a similar project and have a higher degree of certainty of outcomes, or conversely avoid using certain [orgs] because they have proven they cannot deliver.
